...
| 4 | send_email | 通信 | 发送电子邮件。 | contact_name, subject | body |
| 5 | phone_call | 通信 | 拨打指定联系人的电话。 | contact_name | 无 |
| 6 | phone_sms | 通信 | 发送短信。 | contact_name | sms_message |
...
| 17 | show_map | 地图与定位 | 在地图上显示位置。 | query | 无 |
...
| 29 | get_weather | 天气服务 | 获取天气信息。 | 无 | city |
| 30 | create_calendar_event | 日程管理 | 创建一个新的日历事件。 | title, datetime | 无 |
